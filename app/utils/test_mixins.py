...
class ReverseResolveTestMixin(object):
    ...
    def test_reverse(self):
        self.assertEqual(reverse(self.get_view_name()), self.get_url())

    def test_resolve(self):
        resolver_match = resolve(self.get_url())
        self.assertEqual(resolver_match.func.__name__, self.get_view().as_view().__name__)
        self.assertEqual(resolver_match.view_name, self.get_view_name())
